...
*/
double Crown::calculateCrownPowerOfFire()
{
    crownPowerOfFire_ = crownFireFirelineIntensity_ / 129.0;
    return crownPowerOfFire_;
}
...
*/
double Crown::calcuateCrownPowerOfWind()
{
