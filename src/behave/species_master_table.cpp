                                       ...
                                       EquationType equationType, CrownDamageEquationCode crownDamageEquationCode)
{
    ...
    recordTemp.Alaska = gacc1;
    recordTemp.California = gacc2;
    recordTemp.EasternArea = gacc3;
    recordTemp.GreatBasin = gacc4;
    recordTemp.NorthernRockies = gacc5;
    recordTemp.Northwest = gacc6;
    recordTemp.RockeyMountain = gacc7;
    recordTemp.SouthernArea = gacc8;
    recordTemp.Southwest = gacc9;
