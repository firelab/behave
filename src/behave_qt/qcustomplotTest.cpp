    ...
    : QMainWindow(parent)
{
    ...
    for (int i = 0; i < NO_OF_ROWS; i++)
    {
        ...
        behaveVector[i].updateSurfaceInputs(fuelModelNumber, 6, 7, 8, 60, 90, MoistureUnits::PERCENT, windSpeed, 0, WindHeightInputMode::DIRECT_MIDFLAME, 0, SlopeUnits::DEGREES, 0, 0, 0, 0);
